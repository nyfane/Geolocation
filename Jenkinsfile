    ...
    stages {
        ...
        stage ('Pushing to ECR') {
            steps {
                ...
                sh 'docker tag 823008317281.dkr.ecr.us-west-2.amazonaws.com/geolocation_ecr_rep:1.0 .'
                sh 'docker push 823008317281.dkr.ecr.us-west-2.amazonaws.com/geolocation_ecr_rep:1.0'
